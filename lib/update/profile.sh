...
shimmy_target_profile_sync_assets_restore() {
  ...
  for shimmy_target_profile_sync_restore_entry in ai-skills bin commands config lib tools shell-init.sh install-manifest.txt; do
...
shimmy_target_profile_sync_candidate_commit() {
  ...
  for shimmy_target_profile_sync_commit_entry in ai-skills bin commands config lib tools shell-init.sh install-manifest.txt; do
  ...
  for shimmy_target_profile_sync_commit_entry in ai-skills bin commands config lib tools shell-init.sh; do
