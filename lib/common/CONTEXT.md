...
activation, lexical profile, then lexical registry order, releases in reverse,
and removes only exactly revalidated dead-owner records. Cleanup releases only
