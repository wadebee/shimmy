...
images before locking, then commits shim-owned assets with the manifest last
and exact rollback. It also selects non-mutating all/tool/version smokes and
