#!/bin/sh
# Installed public-tool dispatcher.
set -eu
...
common_helper=$install_dir/core/core/common/common.sh
profile_helper=$install_dir/core/core/profile/profile.sh
central_dispatcher=$install_dir/core/commands/dispatch-tool.sh
