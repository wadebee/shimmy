...
test_tools_skopeo_preview_contract() {
  ...
  output=$(SHIMMY_HOST_CA_BUNDLE="$ca_bundle" SHIMMY_SKOPEO_IMAGE=example.invalid/shimmy/skopeo:test SHIMMY_SKOPEO_IMAGE_PULL=always SHIMMY_SKOPEO_AUTH_SECRET=registry-example-auth run_in_repo ./commands/run-tool.sh skopeo --preview-shim --version)
