...
4. Approval scope: require the exact scan mode, targets, ports, network mode,
   and privilege opt-ins. Never persist a broad `nmap` prefix or infer LAN,
   raw-socket, rootful, or privileged authorization from wrapper approval.
