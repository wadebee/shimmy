...
4. Approval scope: require the exact wrapper environment and startup command.
   Wrapper approval does not authorize an MCP admin action; retain the separate
   explicit change-window, object boundary, verification, and rollback approval.
