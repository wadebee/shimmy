...
- The earlier default full suite's only independent baseline failure was `lib-catalog`'s whitespace-sensitive human-table header assertion. Commit `dc7a85b` normalized display padding, and the isolated group passes all six tests on 2026-08-30.
