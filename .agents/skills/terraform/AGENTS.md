...
- Preserve `SHIMMY_TF_IMAGE`, `SHIMMY_TF_IMAGE_PULL`, the `$PWD` mount, the optional AWS and plugin-cache mounts, and the current env forwarding behavior unless the task explicitly changes them.
