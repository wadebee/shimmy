...
- Kind dispatcher: `../../../shims/gh`
- Version shim: `../../../shims/gh_2_94`
- User docs: `../../../docs/shims/gh.md`
- Tests: `../../../scripts/test-shimmy.sh`
- Catalog: `../../../lib/repo/shimmy-catalog.sh`
- Lifecycle scripts: `../../../scripts/status-shimmy.sh` and `../../../scripts/update-shimmy.sh`
...
3. Keep archive installation inside `../../../images/gh_2_94/Containerfile`; the version shim should only coordinate local image selection and runtime behavior.
...
- Preview: `./shims/gh --preview-shim --version`
- Direct smoke: `./shims/gh --version`
